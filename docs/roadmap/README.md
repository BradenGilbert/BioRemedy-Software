...
| 10 | [Front Line — Real Tiles](phase-10-frontline.md) | 🟡 **In progress, Part 1 shipped 2026-09-17** — owner decision: build the web-hosted simulator's tiles to full feature depth now (mobile app / production auth / offline sync decisions explicitly deferred). Part 1 (Time Sheet, Trips, Settings) is real and verified live; Part 2 (Forms, Messaging, Location, Invoices) not yet started. |
