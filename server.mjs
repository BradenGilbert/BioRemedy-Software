...
const defaultBackend = {
  scheduleEvents: [
    ...
    },
    {
      ...
      jobId: "job-clearwater-abatement",
  ...
  crewProfiles: [
    { id: "crew-er-alpha", code: "ER-A", name: "Emergency Response Alpha", supervisorEmployeeId: "emp-logan", type: "Emergency response", status: "Active", timezone: "America/Chicago" },
    { id: "crew-sampling-one", code: "SMP-1", name: "Sampling Crew 1", supervisorEmployeeId: "emp-noah", type: "Sampling", status: "Active", timezone: "America/Chicago" },
  ],
  crewMemberships: [
    { id: "cm-logan-er-a", crewId: "crew-er-alpha", employeeId: "emp-logan", role: "Lead", isLead: true, status: "Active" },
    { id: "cm-trey-er-a", crewId: "crew-er-alpha", employeeId: "emp-trey", role: "Technician", isLead: false, status: "Active" },
    { id: "cm-tristan-er-a", crewId: "crew-er-alpha", employeeId: "emp-tristan", role: "Technician", isLead: false, status: "Active" },
    { id: "cm-noah-sampling", crewId: "crew-sampling-one", employeeId: "emp-noah", role: "Lead Sampler", isLead: true, status: "Active" },
  ],
  availabilityBlocks: [
...
function filterBackendForRole(data, role) {
  return {
    ...
    timeEntries: canAccess(role, "operations") || canAccess(role, "finance") ? data.timeEntries : [],
    ...
    crewMemberships: canAccess(role, "workforce") || canAccess(role, "dispatch") ? data.crewMemberships : [],
